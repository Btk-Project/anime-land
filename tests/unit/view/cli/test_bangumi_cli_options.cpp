...
TEST(BangumiCliOptions, ParsesLoginStorageAndConfig) {
    const char *argv[] = {
        "anime-land-cli", "login", "--token-store", "file",
...
TEST(BangumiCliOptions, SystemIsTheSecureDefault) {
    const char *argv[] = {"anime-land-cli", "status"};
...
TEST(BangumiCliOptions, RejectsUnknownStorageChoice) {
    const char *argv[] = {"anime-land-cli", "logout", "--token-store", "unknown"};
...
TEST(BangumiCliOptions, CommandHelpIsAvailable) {
    const char *argv[] = {"anime-land-cli", "login", "--help"};
...
TEST(BangumiCliOptions, CollectionsDefaultsToSystemStoreAndFirstPage) {
    const char *argv[] = {"anime-land-cli", "collections"};
...
TEST(BangumiCliOptions, LimitRangeIsOneInclusiveToFiftyOneExclusive) {
    const char *minimumArgv[] = {"anime-land-cli", "collections", "--limit", "1"};
    ...
    const char *maximumArgv[] = {"anime-land-cli", "search", "Frieren", "--limit",
                                 "50"};
    ...
    const char *tooLargeArgv[] = {"anime-land-cli", "collections", "--limit", "51"};
...
TEST(BangumiCliOptions, CommonNestedFieldsKeepAbsoluteCliNames) {
    ...
    config.programName = "anime-land-cli";
...
TEST(BangumiCliOptions, ParsesProxyAndLogLevelForEveryCommand) {
    const char *argv[] = {"anime-land-cli", "status", "--proxy",
...
TEST(BangumiCliOptions, RejectsUnknownLogLevel) {
    const char *argv[] = {"anime-land-cli", "login", "--log-level", "verbose"};
...
TEST(BangumiCliOptions, SearchDefaultsToOptionalSystemSession) {
    const char *argv[] = {"anime-land-cli", "search", "Frieren"};
...
TEST(BangumiCliOptions, SearchRequiresKeywordArgument) {
    const char *argv[] = {"anime-land-cli", "search"};
...
TEST(BangumiCliOptions, DoesNotExposeGuiCommand) {
    const char *argv[] = {"anime-land-cli", "gui"};
