...
private:
   ...
   */
    template <typename T>
    auto fromBasicType(const T &value) -> QJsonValue {
        using Value = std::remove_cvref_t<T>;
 ...
 */
template <>
struct CustomParser<QJsonValue> {
    /**
 ...
 */
template <>
struct CustomParser<QJsonObject> {
 ...
 */
template <>
struct CustomParser<QJsonArray> {
 ...
 */
template <>
struct CustomParser<QJsonDocument> {
    /**
